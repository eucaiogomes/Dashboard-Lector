    ...
    return (
      <div className="p-7 space-y-6">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <div className="text-[12.5px] text-[#6b7684] flex items-center gap-1.5 font-medium">
              ...
              <span className="text-[#f47920] font-semibold">Dashboard Executivo</span>
            </div>
            <h1 className="mt-1.5 text-[26px] font-bold text-[#004e4c] tracking-tight flex items-center gap-2.5">
              <i className="icon-dashboard text-[24px] text-[#004e4c]"></i>
          ...
          <button
            ...
            className="h-[38px] px-4.5 bg-[#004e4c] hover:bg-[#00706c] text-white text-[13px] font-semibold rounded-[4px] cursor-pointer transition-colors flex items-center gap-2 shadow-2xs"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
          <div className="bg-white p-4 rounded-lg border border-[#e0e4ea] shadow-xs">
            <div className="text-[12px] font-medium text-[#6b7684] flex items-center justify-between">
              ...
              <i className="icon-participants text-[#004e4c] text-[15px]"></i>
            </div>
            <div className="mt-2 text-[24px] font-bold text-[#004e4c]">2.148</div>
          ...
          <div className="bg-white p-4 rounded-lg border border-[#e0e4ea] shadow-xs">
            <div className="text-[12px] font-medium text-[#6b7684] flex items-center justify-between">
              ...
              <i className="icon-calendar-today text-[#004e4c] text-[15px]"></i>
            </div>
            <div className="mt-2 text-[24px] font-bold text-[#004e4c]">18.420h</div>
            <div className="text-[11px] text-[#0f6b3f] mt-1 font-medium flex items-center gap-1">
          ...
          <div className="bg-white p-4 rounded-lg border border-[#e0e4ea] shadow-xs">
            <div className="text-[12px] font-medium text-[#6b7684] flex items-center justify-between">
              ...
              <i className="icon-performance text-[#004e4c] text-[15px]"></i>
            </div>
            <div className="mt-2 text-[24px] font-bold text-[#004e4c]">8,57h</div>
          ...
          <div className="bg-white p-4 rounded-lg border border-[#e0e4ea] shadow-xs">
            <div className="text-[12px] font-medium text-[#6b7684] flex items-center justify-between">
              ...
              <i className="icon-courses text-[#f47920] text-[15px]"></i>
            </div>
            <div className="mt-2 text-[24px] font-bold text-[#f47920]">42</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div
            onClick={() => onGoToIndicadores('Treinamentos Institucionais')}
            className="bg-white p-5 rounded-lg border border-[#dfe4ea] hover:border-[#004e4c] hover:shadow-md cursor-pointer transition-all flex flex-col justify-between"
          >
            <div>
              <div className="w-9 h-9 rounded bg-[#004e4c]/10 flex items-center justify-center text-[#004e4c] mb-3">
                <i className="icon-legal-document text-[18px]"></i>
              </div>
              <h3 className="text-[16px] font-bold text-[#004e4c]">Treinamentos Institucionais</h3>
            ...
            <div className="mt-4 pt-3 border-t border-[#eef0f3] flex items-center justify-between text-[12.5px] font-semibold text-[#004e4c]">
          ...
          >
            <div>
              ...
              <h3 className="text-[16px] font-bold text-[#004e4c]">Treinamentos Internos</h3>
              <p className="text-[12.5px] text-[#6b7684] mt-1.5 leading-relaxed">
          ...
          >
            <div>
              <div className="w-9 h-9 rounded bg-[#f47920]/10 flex items-center justify-center text-[#f47920] mb-3">
                <i className="icon-manage text-[18px]"></i>
              </div>
              <h3 className="text-[16px] font-bold text-[#004e4c]">Por Centro de Custo</h3>
              <p className="text-[12.5px] text-[#6b7684] mt-1.5 leading-relaxed">
                Desempenho por setor, gestor e supervisor com turmas planejadas, excedentes e cálculo de esforço extra.
              </p>
            </div>
            <div className="mt-4 pt-3 border-t border-[#eef0f3] flex items-center justify-between text-[12.5px] font-semibold text-[#f47920]">
        ...
        <div className="bg-white p-5 rounded-lg border border-[#dfe4ea]">
          <div className="flex items-center justify-between pb-3 border-b border-[#eef0f3]">
            <div className="flex items-center gap-2">
              <i className="icon-calendar text-[#004e4c] text-[16px]"></i>
              <h3 className="text-[15px] font-bold text-[#004e4c]">Próximos Treinamentos Agendados</h3>
            </div>
          ...
          <div className="divide-y divide-[#f0f3f7] mt-2">
            <div className="py-2.5 flex items-center justify-between text-[13px]">
              <div>
                ...
                <span className="ml-2 text-xs text-[#f47920] font-medium bg-[#f47920]/10 px-2 py-0.5 rounded">Obrigatório</span>
              </div>
            ...
            <div className="py-2.5 flex items-center justify-between text-[13px]">
              <div>
                ...
                <span className="ml-2 text-xs text-[#004e4c] font-medium bg-[#004e4c]/10 px-2 py-0.5 rounded">Institucional</span>
              </div>
              <div className="text-right text-[#6b7684] text-xs">
      ...
      <div className="p-7 space-y-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <div className="text-[12.5px] text-[#6b7684] flex items-center gap-1.5 font-medium">
              <span>Minha Área</span>
              <span className="text-[#b6bdc7]">/</span>
              <span className="text-[#f47920] font-semibold">NR-1 — Disposições Gerais e GRO</span>
            </div>
            <h1 className="mt-1.5 text-[26px] font-bold text-[#004e4c] tracking-tight flex items-center gap-2.5">
              <i className="icon-legal-document text-[24px] text-[#004e4c]"></i>
          ...
          <button
            onClick={() => onGoToIndicadores('Treinamentos Institucionais')}
            className="h-[38px] px-4.5 bg-white border border-[#cfd6e0] hover:border-[#004e4c] text-[#004e4c] text-[13px] font-semibold rounded-[4px] cursor-pointer transition-colors flex items-center gap-2"
          >
            <i className="icon-performance text-[14px]"></i>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-4.5 rounded-lg border border-[#e0e4ea]">
            ...
            <div className="text-2xl font-bold text-[#004e4c] mt-1.5">2.024</div>
          ...
          <div className="bg-white p-4.5 rounded-lg border border-[#e0e4ea]">
            ...
            <div className="text-2xl font-bold text-[#f47920] mt-1.5">124</div>
            <div className="text-[11px] text-[#f47920] mt-1">Turmas convocadas para o mês</div>
          </div>
          <div className="bg-white p-4.5 rounded-lg border border-[#e0e4ea]">
        ...
        <div className="bg-white rounded-lg border border-[#dfe4ea] overflow-hidden">
          <div className="p-4 border-b border-[#eef0f3] flex items-center justify-between">
            <h3 className="text-[14.5px] font-bold text-[#004e4c]">Treinamentos Regulamentares por Unidade</h3>
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-[#eef0f3]">
              <tr>
                <td className="py-3 px-4 font-semibold text-[#004e4c]">NR-01 — Integração de Segurança e GRO</td>
              ...
              <tr>
                <td className="py-3 px-4 font-semibold text-[#004e4c]">NR-32 — Segurança em Serviços de Saúde</td>
              ...
              <tr>
                <td className="py-3 px-4 font-semibold text-[#004e4c]">NR-05 — CIPA / Prevenção de Acidentes</td>
              ...
              <tr>
                <td className="py-3 px-4 font-semibold text-[#004e4c]">NR-23 — Proteção Contra Incêndio / Brigada</td>
                ...
                <td className="py-3 px-4 text-center font-medium text-[#f47920]">158</td>
                <td className="py-3 px-4 text-center font-bold text-[#f47920]">87,8%</td>
                <td className="py-3 px-4 text-center"><span className="bg-[#f47920]/10 text-[#f47920] px-2 py-0.5 rounded font-semibold text-[11px]">Em Reciclagem</span></td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="p-7 space-y-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <div className="text-[12.5px] text-[#6b7684] flex items-center gap-1.5 font-medium">
              <span>Minha Área</span>
              <span className="text-[#b6bdc7]">/</span>
              <span className="text-[#f47920] font-semibold">Meus Treinamentos</span>
            </div>
            <h1 className="mt-1.5 text-[26px] font-bold text-[#004e4c] tracking-tight flex items-center gap-2.5">
              <i className="icon-courses text-[24px] text-[#004e4c]"></i>
          ...
          <button
            onClick={() => onGoToIndicadores('Treinamentos Institucionais')}
            className="h-[38px] px-4 bg-white border border-[#cfd6e0] hover:border-[#004e4c] text-[#004e4c] text-[13px] font-semibold rounded-[4px] cursor-pointer transition-colors"
          >
            Ver Indicadores T&amp;D
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="bg-white p-5 rounded-lg border border-[#dfe4ea] flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-xs font-semibold text-[#f47920] mb-2">
                <span>EM ANDAMENTO</span>
                <span>75%</span>
              </div>
              <h3 className="text-[15px] font-bold text-[#004e4c]">Segurança do Paciente &amp; Protocolos Hospitalares</h3>
              ...
              <div className="w-full bg-[#eef0f3] h-2 rounded-full mt-3 overflow-hidden">
                <div className="bg-[#f47920] h-full w-[75%]"></div>
              </div>
            </div>
            <button className="mt-4 w-full py-2 bg-[#004e4c] hover:bg-[#00706c] text-white text-xs font-semibold rounded transition-colors">
          ...
          <div className="bg-white p-5 rounded-lg border border-[#dfe4ea] flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-[15px] font-bold text-[#004e4c]">NR-01 e Integração Institucional Unimed</h3>
          ...
          <div className="bg-white p-5 rounded-lg border border-[#dfe4ea] flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between text-xs font-semibold text-[#004e4c] mb-2">
                <span>NOVA CONVOCAÇÃO</span>
                <span>Prazo: 20/09</span>
              </div>
              <h3 className="text-[15px] font-bold text-[#004e4c]">Comunicação Assertiva e Feedback Construtivo</h3>
              <p className="text-xs text-[#6b7684] mt-1.5">Carga horária: 6h · Trilha de Liderança e Gestão</p>
              <div className="w-full bg-[#eef0f3] h-2 rounded-full mt-3 overflow-hidden">
                <div className="bg-[#004e4c] h-full w-[0%]"></div>
              </div>
            </div>
            <button className="mt-4 w-full py-2 bg-[#00995d] hover:bg-[#00824f] text-white text-xs font-semibold rounded transition-colors">
              Iniciar Agora
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <div className="text-[12.5px] text-[#6b7684] flex items-center gap-1.5 font-medium">
              <span>Minha Área</span>
              <span className="text-[#b6bdc7]">/</span>
              <span className="text-[#f47920] font-semibold">Minhas Trilhas de Aprendizagem</span>
            </div>
            <h1 className="mt-1.5 text-[26px] font-bold text-[#004e4c] tracking-tight flex items-center gap-2.5">
              <i className="icon-trails text-[24px] text-[#004e4c]"></i>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="bg-white p-5 rounded-lg border border-[#dfe4ea]">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-[#f47920] uppercase">Trilha Assistencial de Excelência</span>
              <span className="text-xs font-semibold text-[#6b7684]">3 de 5 Módulos</span>
            </div>
            <h3 className="text-[17px] font-bold text-[#004e4c] mt-1.5">Cuidado Centrado na Pessoa e Práticas Hospitalares</h3>
            ...
            <div className="w-full bg-[#eef0f3] h-2.5 rounded-full mt-3 overflow-hidden">
              <div className="bg-[#f47920] h-full w-[60%]"></div>
            </div>
            <div className="mt-4 space-y-2 border-t border-[#eef0f3] pt-3 text-xs">
              ...
              <div className="flex items-center justify-between text-[#004e4c] font-semibold">
          ...
          <div className="bg-white p-5 rounded-lg border border-[#dfe4ea]">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-[#004e4c] uppercase">Trilha de Liderança Unimed</span>
              <span className="text-xs font-semibold text-[#6b7684]">2 de 4 Módulos</span>
            </div>
            <h3 className="text-[17px] font-bold text-[#004e4c] mt-1.5">Gestão de Pessoas, Cultura e Resultados em Saúde</h3>
            <p className="text-xs text-[#6b7684] mt-1">Carga total: 32 horas · 50% concluída</p>
            <div className="w-full bg-[#eef0f3] h-2.5 rounded-full mt-3 overflow-hidden">
              <div className="bg-[#004e4c] h-full w-[50%]"></div>
            </div>
            <div className="mt-4 space-y-2 border-t border-[#eef0f3] pt-3 text-xs">
              <div className="flex items-center justify-between text-[#0f6b3f]">
      ...
      <div className="p-7 space-y-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <div className="text-[12.5px] text-[#6b7684] flex items-center gap-1.5 font-medium">
              <span>Minha Área</span>
              <span className="text-[#b6bdc7]">/</span>
              <span className="text-[#f47920] font-semibold">Meus Certificados</span>
            </div>
            <h1 className="mt-1.5 text-[26px] font-bold text-[#004e4c] tracking-tight flex items-center gap-2.5">
              <i className="icon-certificate text-[24px] text-[#004e4c]"></i>
        ...
        <div className="bg-white rounded-lg border border-[#dfe4ea] overflow-hidden">
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-[#eef0f3]">
              <tr>
                <td className="py-3 px-4 font-semibold text-[#004e4c]">NR-01 — Integração Geral de Segurança</td>
                ...
                <td className="py-3 px-4 text-right">
                  <button className="text-[#004e4c] hover:text-[#f47920] font-semibold flex items-center gap-1 ml-auto">
                    <i className="icon-pdf text-[13px]"></i> Baixar PDF
                  </button>
                </td>
              </tr>
              <tr>
                <td className="py-3 px-4 font-semibold text-[#004e4c]">Protocolos de Prevenção de Quedas e Lesões</td>
              ...
              <tr>
                <td className="py-3 px-4 font-semibold text-[#004e4c]">Boas Práticas de Higiene das Mãos e Biossegurança</td>
      ...
      <div className="p-7 space-y-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <div className="text-[12.5px] text-[#6b7684] flex items-center gap-1.5 font-medium">
              <span>Minha Área</span>
              <span className="text-[#b6bdc7]">/</span>
              <span className="text-[#f47920] font-semibold">Meu Calendário</span>
            </div>
            <h1 className="mt-1.5 text-[26px] font-bold text-[#004e4c] tracking-tight flex items-center gap-2.5">
              <i className="icon-calendar text-[24px] text-[#004e4c]"></i>
        ...
        <div className="bg-white p-5 rounded-lg border border-[#dfe4ea]">
          <div className="flex items-center justify-between pb-4 border-b border-[#eef0f3]">
            <h3 className="text-[16px] font-bold text-[#004e4c]">Agosto / Setembro 2026</h3>
          ...
          <div className="mt-4 space-y-3">
            <div className="p-3.5 rounded border border-[#eef0f3] bg-[#f8fafc] flex items-center justify-between">
              <div className="flex items-center gap-3.5">
                <div className="w-10 h-10 rounded bg-[#004e4c] text-white flex flex-col items-center justify-center text-xs font-bold leading-tight">
                  <span>02</span>
                  <span className="text-[9px] font-normal uppercase">Set</span>
                </div>
                <div>
                  <h4 className="text-[14px] font-bold text-[#004e4c]">Treinamento Presencial NR-32</h4>
            ...
            <div className="p-3.5 rounded border border-[#eef0f3] bg-[#f8fafc] flex items-center justify-between">
              <div className="flex items-center gap-3.5">
                <div className="w-10 h-10 rounded bg-[#f47920] text-white flex flex-col items-center justify-center text-xs font-bold leading-tight">
                  <span>05</span>
                  <span className="text-[9px] font-normal uppercase">Set</span>
                </div>
                <div>
                  <h4 className="text-[14px] font-bold text-[#004e4c]">Workshop de Experiência do Paciente</h4>
                  <p className="text-xs text-[#6b7684]">Horário: 14:00 às 17:00 · Local: Sala de Treinamentos Sede</p>
                </div>
              </div>
              <span className="text-xs font-semibold text-[#f47920] bg-white px-2.5 py-1 rounded border border-[#dfe4ea]">Turma Agendada</span>
            </div>
            ...
            <div className="p-3.5 rounded border border-[#eef0f3] bg-[#f8fafc] flex items-center justify-between">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <h4 className="text-[14px] font-bold text-[#004e4c]">Prazo Final: Avaliação EAD de Farmacovigilância</h4>
  ...
  return (
    <div className="p-7 space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <div className="text-[12.5px] text-[#6b7684] flex items-center gap-1.5 font-medium">
            <span>Minha Área</span>
            <span className="text-[#b6bdc7]">/</span>
            <span className="text-[#f47920] font-semibold">{activeItem}</span>
          </div>
      ...
      <div className="bg-white p-6 rounded-lg border border-[#dfe4ea] text-center py-12">
        <div className="w-12 h-12 rounded-full bg-[#004e4c]/10 text-[#004e4c] flex items-center justify-center mx-auto mb-3">
          <i className="icon-documents text-[22px]"></i>
        </div>
        <h3 className="text-[17px] font-bold text-[#004e4c]">Módulo de {activeItem}</h3>
        ...
        <button
          onClick={() => onGoToIndicadores('Treinamentos Institucionais')}
          className="mt-5 px-4 py-2 bg-white border border-[#004e4c] text-[#004e4c] hover:bg-[#004e4c]/5 text-xs font-semibold rounded transition-colors"
        >
