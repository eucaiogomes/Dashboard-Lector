...
export const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer className="no-print w-full bg-[#0c244c] border-t border-[#091b38] py-5 px-8 flex flex-col md:flex-row items-center justify-between gap-4 text-white relative select-none">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="w-5 h-5 flex items-center justify-center">
              <svg viewBox="0 0 100 100" className="w-5 h-5">
                <path d="M20,50 C20,30 40,20 60,30 C80,40 80,70 60,80 C40,90 20,70 20,50 Z" fill="none" stroke="#eb6200" strokeWidth="12" />
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[16px] font-semibold text-[#eb6200] italic">live</span>
        </div>
      </footer>
      ...
      <div className="fixed right-5 bottom-5 z-40">
        <button
          ...
          className="w-12 h-12 rounded-full bg-[#eb6200] hover:bg-[#cf5700] text-white flex items-center justify-center shadow-lg hover:shadow-xl transition-all cursor-pointer hover:scale-105 border-2 border-white"
        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg border border-[#cfd6e0] shadow-xl max-w-sm w-full p-5 text-[#1f2733]">
            <div className="flex items-center justify-between pb-3 border-b border-[#eef0f3]">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-full bg-[#eb6200] text-white flex items-center justify-center text-xs">
                  <i className="icon-livia text-[15px]"></i>
                </div>
                <h3 className="text-[15px] font-bold text-[#183a75]">Suporte Unimed &amp; Livia</h3>
              </div>
              <button
                onClick={() => setShowSupportModal(false)}
                className="text-[#8a93a0] hover:text-[#183a75] p-1"
              >
            ...
            <div className="py-4 text-xs space-y-3 text-[#4a5462]">
              ...
              <div className="p-3 bg-[#f8fafc] rounded border border-[#dfe4ea] space-y-1.5">
                <div className="font-semibold text-[#183a75]">Setor de T&amp;D Unimed:</div>
            ...
            <div className="pt-2 flex justify-end">
              <button
                onClick={() => setShowSupportModal(false)}
                className="px-4 py-1.5 bg-[#183a75] hover:bg-[#122c59] text-white text-xs font-semibold rounded"
              >
                Fechar
              </button>
            </div>
