        ...
        <div className="p-4 px-6 bg-white text-[#1f2733] flex items-center justify-between border-b border-[#e4e8ee] shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-[#f0f4f8] border border-[#d8e0ea] flex items-center justify-center">
              <i className="icon-performance text-[20px] text-[#eb6200]"></i>
            </div>
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h2 className="text-[17px] font-bold tracking-tight text-[#183a75]">
                  Relatório &amp; Indicadores T&amp;D Detalhados
                </h2>
                <span className="text-[11px] font-bold bg-[#eb6200] text-white px-2.5 py-0.5 rounded-full shadow-2xs">
                  {card.title}
                </span>
              </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="h-8 px-3 rounded bg-white hover:bg-[#f0f4f8] text-[#183a75] text-[12px] font-semibold flex items-center gap-1.5 transition-colors cursor-pointer border border-[#cfd6e0]"
            ...
            <button
              ...
              className="w-8 h-8 rounded-md bg-white hover:bg-[#f0f4f8] text-[#64748b] hover:text-[#183a75] flex items-center justify-center transition-colors cursor-pointer border border-[#cfd6e0]"
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
          ...
          <div className="bg-white rounded-lg border border-[#cfd6e0] shadow-sm p-5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#e5e9f0]">
              <div>
                <div className="flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#eb6200]"></span>
                  <h3 className="text-[17px] font-bold text-[#183a75] tracking-tight">
                    {card.title}
                  </h3>
                  <span className="text-[11px] font-bold text-[#183a75] bg-[#183a75]/10 px-2 py-0.5 rounded">
                    Gráfico em Destaque
                  </span>
                </div>
                {card.subtitle && (
                ...
                <div className="flex items-center gap-1.5 text-xs text-[#4a5462]">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="h-[30px] pl-2.5 pr-7 bg-[#f8fafc] border border-[#cfd6e0] rounded text-xs font-semibold text-[#183a75] appearance-none cursor-pointer outline-none focus:border-[#183a75]"
                    >
                  ...
                  {card.allowedTypes.map(t => (
                    <button
                      ...
                      className={`px-2.5 py-1 text-[11px] font-bold rounded transition-all cursor-pointer ${
                        card.chartType === t
                          ? 'bg-[#183a75] text-white shadow-2xs'
                          : 'text-[#64748b] hover:text-[#183a75]'
                      }`}
                    >
                      {t}
                    </button>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 my-4 bg-[#f8fafc] p-3 rounded-md border border-[#e8edf2]">
              <div className="text-center sm:text-left sm:pl-2">
                ...
                <span className="text-[17px] font-bold text-[#183a75]">
              ...
              <div className="text-center sm:text-left sm:pl-2">
                ...
                <span className="text-[17px] font-bold text-[#eb6200]">
              ...
              <div className="text-center sm:text-left sm:pl-2">
                ...
                <span className="text-[14px] font-bold text-[#4a5462] flex items-center justify-center sm:justify-start gap-1 mt-0.5">
                  <i className="icon-performance text-[#eb6200] text-[13px]"></i>
          ...
          <div className="bg-white rounded-lg border border-[#cfd6e0] shadow-sm overflow-hidden">
            ...
            <div className="p-4 px-6 bg-white border-b border-[#e4e8ee] flex items-center justify-between">
              <div>
                <h3 className="text-[16px] font-bold flex items-center gap-2 text-[#183a75]">
                  <i className="icon-performance text-[#eb6200] text-[18px]"></i>
                ...
                return (
                  <button
                    ...
                    className={`h-[44px] px-5 border-none text-[13px] font-bold cursor-pointer transition-all border-b-2 whitespace-nowrap flex items-center gap-2 ${
                      isActive
                        ? 'bg-white text-[#183a75] border-[#eb6200] shadow-2xs'
                        : 'text-[#6b7684] border-transparent hover:text-[#183a75] hover:bg-white/50'
                    }`}
                  >
                    <i
                      className={`${
                        tab === 'Treinamentos Institucionais'
                          ...
                          ? 'icon-courses'
                          : 'icon-manage'
                      } text-[13px] ${isActive ? 'text-[#eb6200]' : 'text-[#8a93a0]'}`}
                    ></i>
                    <span>{tab}</span>
                  </button>
                );
